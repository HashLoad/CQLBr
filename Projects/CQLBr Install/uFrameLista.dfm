object framePacotes: TframePacotes
  ...
  object ScrollBox1: TScrollBox
    ...
    object Label13: TLabel
      ...
      Margins.Left = 5
      Caption = 
        'Componentes n'#227'o visuais para adicionar todas units necess'#225'rias d' +
        'o link escolhido ao seu projeto.'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = 33023
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object Label3: TLabel
      ...
      Height = 13
      Margins.Left = 5
      Caption = 'Registrar o CQLBr Framework for Delphi/Lazarus na IDE do Delphi'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = 33023
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object CQLBrDriversLinks_dpk: TCheckBox
      Left = 12
      Top = 66
      Width = 16
      Height = 17
      Hint = 'CQLBrDriversLinks.dpk'
      Checked = True
      State = cbChecked
      TabOrder = 1
    end
    object CQLBrLibrary_dpk: TCheckBox
      Left = 12
      Top = 42
      Width = 16
      Height = 17
      Hint = 'CQLBrLibrary.dpk'
      Checked = True
      Enabled = False
      State = cbChecked
      TabOrder = 0
